/**
 * 定义菜品和页面模型 ,为了提高性能，不使用Sencha Touch的DataStore，而使用
 * 最快速高效的数组和对象
 */
//类别数据
var typesData = ['凉菜' , '热菜'	, '酒水' , '点心' , '特色套餐'];

//每页类别数据
var typeIndex = { '凉菜' : [1 , 2, 3, 4, 5] , 
		'热菜' : [5 ,6 , 7, 8, 9] , 
		'酒水' : [9, 10 , 11 ] ,
		'点心' : [12, 13, 14] , 
...
var coverDate = [
    {
		image : 'images/p0-1.jpg', cls : 'cover-page' , 
	 ...
	 */
	{
		image : 'images/p0-2.jpg', cls : 'cover-page' , 
		html : "" 
	}] ;
